...
\item Evaluated adversarial robustness using PGD attacks under multiple compression configurations.
...
\item Designed and deployed domain-specific RAG systems using FAISS and AWS Bedrock.
...
Web \& UI/UX Director \hfill Apr 2026 -- Present
